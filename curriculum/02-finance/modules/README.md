...
Finans modulu, 8 ana konu basligi altinda yapilandirilmis alt modullerden olusmaktadir. Turev urunler, risk yonetimi, ESG/surdurulebilir finans, alternatif yatirim araclari ve Turk vergi sistemi konulari mevcut haftalara entegre edilmistir. Her alt modul, bagimsiz olarak ele alinabilecek sekilde tasarlanmis olmakla birlikte, modulun butunlugu icinde birbirini tamamlayacak sekilde siralanmistir.
...
- **Hafta:** 7 (2 hafta önerilen)
- **Temel Odak:** Entegre 3-statement model, Excel renk kodlama standartlari, duyarlilik analizi, senaryo yonetimi, bakiye kontrol mekanizmalari, ileri modelleme teknikleri, cok degiskenli duyarlilik analizi
...
- **Haftalar:** 8-9
- **Temel Odak:** Modern Portfoy Teorisi (Markowitz), CAPM, Fama-French faktor modelleri, portfoy performans olcumu, tahvil degerleme, türev ürünler (VİOP, forward, futures, opsiyon, swap), risk yönetimi (VaR, stres testi), alternatif yatirim araclari (GYO, emtia, private equity)
- **On Kosul:** M1-FIN03 (WACC ve risk-getiri kavramlari)
- **Cikti Yetkinlik:** Bir portfoyun risk/getiri profilini hesaplama, beta hesaplama, türev ürünlerle hedging stratejisi tasarlama, VaR hesaplama ve portfoy optimizasyonu yapabilme
...
- **Hafta:** 12
- **Temel Odak:** BIST yapisi, SPK duzenlemeleri, enflasyon muhasebesi (TMS 29), KAP kullanimi, IPO sureci, Turkiye'de kurumsal finansman, ESG ve sürdürülebilir finans (BIST Surdurulebilirlik Endeksi, yesil tahviller), Turk vergi sistemi ve finansal kararlar (Kurumlar vergisi, yatirim tesvikleri, KDV istisnalari, stopaj), BDDK ve bankacilik duzenlemeleri
- **On Kosul:** Tum onceki moduller (butunlesik sentez haftasi)
- **Cikti Yetkinlik:** Bir BIST sirketinin finansal analizini Turkiye ozelinde yapabilme ve SPK standartlarinda raporlama; ESG faktorlerini ve vergisel etkileri finansal kararlara entegre edebilme
...
Hafta 4-6:  M1-FIN03 (Kurumsal Finansman)
                 |
Hafta 7:    M1-FIN04 (Finansal Modelleme) [2 hafta önerilen]
                 |
Hafta 8-9:  M1-FIN05 (Yatirim ve Portfoy + Turev Urunler + Risk Yonetimi)
                 |
Hafta 10:   M1-FIN06 (Davranissal Finans)
                 |
Hafta 11:   M1-FIN07 (Startup Finansmani)
                 |
Hafta 12:   M1-FIN08 (Turkiye'de Finans + ESG + Vergi + BDDK)
```
