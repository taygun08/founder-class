...
- **Akbulut, A. (2021).** *TMS/TFRS Uygulamaları* (4. Baskı). Beta Yayınevi. ISBN: 978-6052420108.
  — Türkiye Muhasebe Standartları ve Türkiye Finansal Raporlama Standartlarının uygulamalı anlatımı.

- **Pazareeviren, S. (2019).** *Stratejik Yönetim Muhasebesi*. Detay Yayıncılık. ISBN: 978-6052321511.
  — Stratejik yönetim muhasebesi konusunda Türkiye'deki nadir kaynaklardan.

- **Küçük, E. (2019).** *Tebliğler ve Yorumlarla Muhasebe Uygulamaları*. Nobel Yayınevi. ISBN: 978-6053209861.
  — MSUGT tebliğleri ve uygulama örnekleriyle kapsamlı bir çalışma.

- **Pratik, B. (2022).** *Finansal Tablolar ve Nakit Akış Analizi*. Seçkin Yayınevi. ISBN: 978-9750248765.
  — Nakit akış tablosuna odaklanan uygulamalı kaynak.

- **Akyel, N. (2021).** *İç Denetim ve Risk Yönetimi*. Türkiye İç Denetim Enstitüsü Yayını. ISBN: 978-9750123450.
  — İç denetim ve risk yönetimi alanında Türkiye'deki temel eserlerden.

- **Kısa, S. (2024).** *TMS 29 Uygulama Rehberi: Enflasyon Düzeltmesi*. Yaklaşım Yayıncılık.
  — Türkiye'de 2024 yılında yeniden gündeme gelen enflasyon muhasebesi uygulaması için güncel rehber.

---

## 2. MUHASEBE STANDARTLARI VE MEVZUAT

### Uluslararası Standartlar

- **IASB (2023).** *IFRS Standards — Blue Book*. IFRS Foundation. London.
  — Uluslararası Finansal Raporlama Standartları'nın (IFRS) resmî yayını.

- **IAASB (2023).** *International Standards on Auditing (ISA)*. IFAC. New York.
  — Uluslararası Denetim Standartları.

- **COSO (2013).** *Internal Control — Integrated Framework*. Committee of Sponsoring Organizations of the Treadway Commission.
  — İç kontrol sistemi için dünya çapında kabul gören çerçeve.

- **IASB (2018).** *Conceptual Framework for Financial Reporting*. IFRS Foundation.
  — Finansal raporlamanın kavramsal çerçevesi.

### Türkiye'deki Standartlar ve Mevzuat

- **KGK (2024).** *Türkiye Muhasebe Standartları (TMS) ve Türkiye Finansal Raporlama Standartları (TFRS) Seti*. Kamu Gözetimi, Muhasebe ve Denetim Standartları Kurumu. www.kgk.gov.tr
  — TMS/TFRS'nin resmî ve güncel metinleri.

- **KGK (2022).** *Bağımsız Denetim Standartları (BDS) Seti*. Kamu Gözetimi, Muhasebe ve Denetim Standartları Kurumu.
  — Türkiye'deki bağımsız denetim standartları (ISA ile uyumlu).

- **SPK (2023).** *Sermaye Piyasasında Finansal Raporlamaya İlişkin Esaslar Tebliği (II-14.1)*. Sermaye Piyasası Kurulu.
  — BIST şirketlerinin finansal raporlama yükümlülükleri.

- **SPK (2023).** *Bağımsız Denetim Yönetmeliği*. Sermaye Piyasası Kurulu.
  — Halka açık şirketlerin bağımsız denetime tabi olma esasları.

- **GİB (2024).** *Vergi Usul Kanunu (VUK) — 213 Sayılı Kanun*. Gelir İdaresi Başkanlığı. www.gib.gov.tr
  — Türkiye'deki vergisel muhasebe kayıt ve düzenlemelerinin temel kanunu.

- **TC Resmî Gazete (1992).** *1 No'lu Muhasebe Sistemi Uygulama Genel Tebliği (MSUGT)*. 26.12.1992 tarih, 21447 sayılı Resmî Gazete.
  — Tek düzen hesap planının ve muhasebe uygulamalarının temel tebliği.

- **TC Resmî Gazete (2023).** *TMS 29 — Yüksek Enflasyonlu Ekonomilerde Finansal Raporlamaya İlişkin Duyuru*. KGK duyurusu, 2023.
  — 2023-2024 döneminde TMS 29'un yeniden uygulanması hakkında duyuru.

---

## 3. ONLINE KURSLAR VE PLATFORMLAR

### Ücretli / Sertifikalı Kurslar
...
- **YouTube — "muhasebedersleri" kanalı**
  — Türkiye'deki muhasebe öğrencileri için kapsamlı anlatımlar.

- **YouTube — "TMS/TFRS Akademi" kanalı**
  — Türkiye Muhasebe Standartları uygulamalı anlatımları.

- **YouTube — "Financial Accounting" (edX açık ders kayıtları)**
  — Temel muhasebe kavramları.

- **KAP (Kamuyu Aydınlatma Platformu) — www.kap.org.tr**
  — BIST şirketlerinin yıllık/ara dönem finansal tabloları ve bağımsız denetim raporları.

- **KGK — www.kgk.gov.tr**
  — TMS/TFRS seti, denetim standartları, rehber dokümanlar.

- **SPK — www.spk.gov.tr**
  — Sermaye piyasası mevzuatı, tebliğler, duyurular.

- **TÜİK — www.tuik.gov.tr**
  — TMS 29 için gerekli fiyat endeksleri (TÜFE, TEFE).

- **Merkez Bankası — www.tcmb.gov.tr**
  — Sektör hesapları, ödeme istatistikleri, faiz oranları.

---

## 4. HAKEMLİ DERGİ VE AKADEMİK MAKALELER

- *The Accounting Review* — American Accounting Association
- *Journal of Accounting and Economics* — Elsevier
- *Journal of Accounting Research* — Wiley / University of Chicago
- *Accounting, Organizations and Society* — Elsevier
- *Contemporary Accounting Research* — Canadian Academic Accounting Association
- *Muhasebe ve Denetime Bakış* — Türkiye Muhasebe Uzmanları Derneği
- *Muhasebe Bilim Dünyası Dergisi* — Muhasebe Öğretim Üyeleri Bilim ve Dayanışma Vakfı (MÖDAV)
- *Mali Çözüm Dergisi* — İstanbul Serbest Muhasebeci Mali Müşavirler Odası (İSMMMO)
- *World of Accounting Science* — Türkiye

---

## 5. PROFESYONEL KURULUŞLAR VE KURUMLAR

- **KGK** — Kamu Gözetimi, Muhasebe ve Denetim Standartları Kurumu (www.kgk.gov.tr)
- **SPK** — Sermaye Piyasası Kurulu (www.spk.gov.tr)
- **TÜRMOB** — Türkiye Serbest Muhasebeci Mali Müşavirler ve Yeminli Mali Müşavirler Birliği (www.turmob.org.tr)
- **İSMMMO** — İstanbul Serbest Muhasebeci Mali Müşavirler Odası (www.ismmmo.org.tr)
- **TİDE** — Türkiye İç Denetim Enstitüsü (www.tide.org.tr)
...
## 6. KAP KULLANIMI İÇİN ÖRNEK ŞİRKETLER

Aşağıdaki BIST şirketlerinin KAP (kap.org.tr) üzerinden finansal tabloları ve bağımsız denetim raporları incelenebilir:

| Şirket | BIST Kodu | Sektör |
|---|---|---|
| Tofaş Türk Otomobil Fabrikası A.Ş. | TOASO | Otomotiv |
| Tüpraş Türkiye Petrol Rafinerileri A.Ş. | TÜPRAŞ | Enerji |
| Ereğli Demir ve Çelik Fabrikaları T.A.Ş. | EREĞL | Demir-Çelik |
| Türk Hava Yolları A.O. | THYAO | Havacılık |
| BİM Birleşik Mağazalar A.Ş. | BİMAS | Perakende |
| Şişecam | SİSE | Cam |
| Koç Holding A.Ş. | KCHOL | Holding |
| Sasa Polyester Sanayi A.Ş. | SASA | Kimya |

Her bir şirket için son 3 yıllık finansal tablolar, bağımsız denetim raporları ve yatırımcı sunumları karşılaştırmalı olarak incelenebilir.

---

## 7. EXCEL / MUHASEBE YAZILIMLARI
...
## 8. GÖSTERGE NİTELİĞİNDE BLOG VE PORTALLAR

- **MuhasebeTr** — www.muhasebetr.com
- **MuhasebeNet** — www.muhasebenet.com
- **MaliMüşavir** — www.malimusavir.net
- **FinansGündem** — www.finansgundem.com
- **Bloomberg HT** — www.bloomberght.com
- **Dünya Gazetesi** — www.dunya.com
- **Ekonomim** — www.ekonomim.com
