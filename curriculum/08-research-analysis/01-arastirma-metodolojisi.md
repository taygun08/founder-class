...
5. **Directed Acyclic Graphs (DAGs)**: Nedensel iliskileri gorsel bir grafik olarak modelleme. Scott Cunningham'in "Causal Inference: The Mixtape" kitabinda DAG'lerin pratik kullanimi detayli olarak ele alinir.
...
## 1.10 Deney Kulturu (Experimentation Culture)

Deney kulturu (experimentation culture), bir organizasyonun kararlarini veri ve kontrollu deneylerle alma aliskanligidir. A/B testi yapmak teknik bir beceriyken, deney kulturu bunu organizasyonel bir norm haline getirmektir.

### Deney Kulturunun Bilesenleri

1. **Psikolojik Guvenlik:** Calisanlar basarisiz deneyler icin cezalandirilmaz. Her deney, basarili veya basarisiz, bir ogrenme firsatidir.
2. **Veriye Erisim:** Herkesin ihtiyac duydugu veriye ulasabilmesi (self-serve analytics). Veri, sadece veri ekibinin degil, herkesin aracidir.
3. **Deney Altyapisi:** A/B testi, feature flag, randomization platformu gibi teknik altyapi. Microsoft'un "ExP" platformu, Google'in "Overload" altyapisi gibi.
4. **Karar Yetkisi:** Karar vericilerin, test sonuclarina gore karar degistirme esnekligi. On yargilardan arinmis karar mekanizmasi.

### Deney Kulturunu Olusturma Adimlari

**Adim 1: Kucuk Basla (Pilot Ekip)**
- Bir ekiple baslayin (ornegin: urun ekibi veya pazarlama ekibi)
- Basit bir A/B testi ile basari elde edin
- Bu basariyi sirket genelinde hikayelestirin

**Adim 2: Altyapiyi Kur**
- Feature flag sistemi (LaunchDarkly, Split.io)
- Randomizasyon ve orneklem yonetimi
- Sonuc takip dashboard'lari
- Istatistiksel anlamlilik hesaplama araclari

**Adim 3: Egitim ve Standartlar**
- Ekiplere deney tasarimi egitimi
- Hipotez yazma template'i
- Deney onay sureci
- Deney sonucu raporlama standardi

**Adim 4: Kulturlesme**
- Her karar icin "bunu test edebilir miyiz?" sorusunu norm haline getirmek
- Basarisiz deneylerden ogrenilen dersleri sirketle paylasmak
- Deney takvimi ve deney envanteri tutmak
- Deney sonuclarina gore karar alma aliskanligi gelistirmek

### Deney Kulturunun Is Dunyasindaki Onemi

**Neden Onemli?**
- **Hipotezleri Dogrulama:** Varsayimlarla degil, veriyle karar almak
- **Inovasyon Hizi:** Kucuk deneylerle hizli ogrenme, buyuk hatalardan kacinma
- **Kaynak Verimliligi:** Is yaramayan fikirlere gereksiz yatirim yapmama
- **Objektiflik:** Kisilerin egolarindan bagimsiz, veriye dayali karar mekanizmasi

**Ornek: Booking.com Deney Kulturu**
- Booking.com, deney kulturunu sirket DNA'sina yerlestirmis bir firma olarak bilinir
- Her yil binlerce A/B testi calistirilir
- Calisanlara "deney zihniyeti" asilanir: her fikir bir hipotezdir, test edilmelidir
- Basarisiz deneyler "ogrenme" olarak degerlendirilir, cezalandirilmaz
- CEO'dan stajyere kadar herkes deney sonuclarina gore karar alir

**Is Dunyasi Icin Cikarimlar:**
- Deney kulturu, teknoloji sirketlerine ozgu degildir; perakende, finans, saglik gibi geleneksel sektorlerde de uygulanabilir
- Deney kulturu olusturmak icin once "psikolojik guvenlik" saglanmalidir
- Her karar bir deney degildir; kritik kararlarda deney yapmak mumkun olmayabilir
- Deney kulturu, agile ve data-driven culture ile ic ice gecmis bir kavramdir
