...
> Mufredat modullerini destekleyen online kurslar, sertifika programlari ve video kaynaklari.
...
| # | Kanal | Icerik | Egitmen/Uretici | Seviye | Ilgili Modul |
|---|-------|--------|-----------------|--------|-------------|
| 1 | **Damodaran Online** | Sirket degerlemesi, finans dersleri (NYU) | Aswath Damodaran | Orta/Ileri | Finans, Degerleme |
| 2 | **YC Startup School** | Startup kurma ve buyutme uzerine videolar | Y Combinator | Baslangic | Girisimcilik |
| 3 | **Stanford E-Corner** | Girisimcilik ve inovasyon dersleri | Stanford University | Baslangic | Girisimcilik |
| 4 | **MIT OpenCourseWare** | MIT finans, ekonomi ve veri bilimi dersleri | MIT | Ileri | Finans, Veri |
| 5 | **Harvard Business Review** | Liderlik, strateji ve yonetim videolari | HBR | Baslangic | Liderlik, Strateji |
| 6 | **3Blue1Brown** | Matematik, lineer cebir, istatistik gorsellestirmeleri | Grant Sanderson | Orta | Veri, Matematik |
| 7 | **StatQuest with Josh Starmer** | Istatistik ve makine ogrenmesi aciklamalari | Josh Starmer | Baslangic | Istatistik, ML |
| 8 | **Patrick Boyle** | Finans, yatirim ve ekonomi analizleri | Patrick Boyle | Orta | Finans |
| 9 | **The Plain Bagel** | Kisisel finans ve yatirim temelleri | Richard Coffin | Baslangic | Finans |
| 10 | **How Money Works** | Finansal sistem ve ekonomi anlatimlari | — | Baslangic | Finans |
| 11 | **Ali Abdaal** | Verimlilik, ogrenme ve kisisel gelisim | Ali Abdaal | Baslangic | Kisisel Gelisim |
| 12 | **a16z** | Teknoloji, startup ve VC trendleri | Andreessen Horowitz | Orta | Girisimcilik, Teknoloji |
| 13 | **Gerekli Seyler** | Ekonomi, finans ve girisimcilik (Turkce) | Gerekli Seyler | Baslangic | Genel-Is Dunyasi |
| 14 | **BTK Akademi** | Yazilim ve teknoloji egitimleri (Turkce) | BTK | Baslangic | Teknoloji |
...
## Ucretsiz / Acik Kaynak Kaynaklar

| # | Kaynak | Platform | Icerik | Link |
|---|--------|----------|--------|------|
| 1 | **Financial Theory (ECON 251)** | Yale Open Courses | John Geanakoplos finans teorisi dersleri | [oyc.yale.edu](https://oyc.yale.edu/economics/econ-251) |
| 2 | **The Theory of Money and Banking** | Yale Open Courses | Para ve bankacilik teorisi | [oyc.yale.edu](https://oyc.yale.edu/economics/econ-252) |
| 3 | **Justice** | Harvard / edX | Michael Sandel'in meshur adalet dersleri | [justiceharvard.org](https://justiceharvard.org) |
| 4 | **CS50: Introduction to Computer Science** | Harvard / edX | David Malan'in bilgisayar bilimine giris dersi | [cs50.harvard.edu](https://cs50.harvard.edu) |
| 5 | **Startup School** | Y Combinator | Startup kurma uzerine 10 haftalik program | [startupschool.org](https://www.startupschool.org) |
| 6 | **Financial Markets (ECON 252)** | Yale / Coursera | Robert Shiller'in finansal piyasalar dersi | [coursera.org/learn/financial-markets-global](https://www.coursera.org/learn/financial-markets-global) |
| 7 | **Khan Academy - Finance & Capital Markets** | Khan Academy | Finansal piyasa temelleri ucretsiz | [khanacademy.org](https://www.khanacademy.org/economics-finance-domain/core-finance) |
| 8 | **MIT OpenCourseWare** | MIT | Tum MIT ders notlari ve videolari ucretsiz | [ocw.mit.edu](https://ocw.mit.edu) |
| 9 | **Investopedia** | Investopedia | Finansal terimler ve makaleler icin kapsamli sozluk | [investopedia.com](https://www.investopedia.com) |
| 10 | **Paul's Online Math Notes** | Lamar University | Matematik notlari (istatistik, lineer cebir, kalkulus) | [tutorial.math.lamar.edu](https://tutorial.math.lamar.edu) |
...
## Podcast'ler (Egitim Amacli)

| # | Podcast | Uretici | Odak | Platform |
|---|---------|---------|------|----------|
| 1 | **Exchanges at Goldman Sachs** | Goldman Sachs | Ekonomi, finans, piyasalar | Spotify/Apple |
| 2 | **Masters in Business** | Bloomberg (Barry Ritholtz) | Yatirim, finans profilleri | Spotify/Apple |
| 3 | **a16z Podcast** | Andreessen Horowitz | Teknoloji, startup, VC | Spotify/Apple |
| 4 | **Acquired** | Ben Gilbert & David Rosenthal | Sirket hikayeleri ve BASS | Spotify/Apple |
| 5 | **The Tim Ferriss Show** | Tim Ferriss | Verimlilik, yatirim, biyografiler | Spotify/Apple |
| 6 | **How I Built This** | NPR (Guy Raz) | Startup kurucu hikayeleri | Spotify/Apple |
| 7 | **The Knowledge Project** | Shane Parrish | Karar alma, zihinsel modeller | Spotify/Apple |
| 8 | **Invest Like the Best** | Patrick O'Shaughnessy | Yatirim felsefesi ve stratejileri | Spotify/Apple |
| 9 | **Y Combinator Podcast** | Y Combinator | Startup ve girisimcilik | Spotify/Apple |
| 10 | **The Ezra Klein Show** | NYT | Politika, ekonomi, teknoloji | Spotify/Apple |

---

## Okuma Listeleri & Calisma Plani Onerileri

### 2 Haftalik Hizli Baslangic
1. *AI For Everyone* (Coursera - Andrew Ng) - ~1 hafta
2. *Financial Markets* (Coursera - Shiller) - ~1 hafta
3. *YC Startup School* – ilk 5 video
4. *Atomic Habits* (kitap) - ilk 3 bolum

### 3 Aylik Yogun Program (Finans Odakli)
1. Machine Learning Specialization (Coursera) - Hafta 1-4
2. CFA Level 1 calismalari (Alternatif)
3. Damodaran degerleme videolari - Hafta 5-8
4. MIT OpenCourseWare finans dersleri - Hafta 9-12

### 3 Aylik Yogun Program (Girisimcilik Odakli)
1. YC Startup School - Hafta 1-3
2. The Lean Startup + Zero to One okumalari - Hafta 4-6
3. Wharton Entrepreneurship Specialization - Hafta 7-9
4. Business Model Generation uygulamali - Hafta 10-12

### Surekli Ogrenme
- Haftada 1 kitap (veya 2 haftada 1)
- Her gun 1 saat online ders/ video
- Haftalik 1 podcast bolumu
- Ayda 1 vaka analizi veya finansal modelleme calismasi
